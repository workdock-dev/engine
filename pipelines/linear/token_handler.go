...
func newTokenHandler(secretManager ports.ForSecrets, client LinearClientInterface) *tokenHandler {
	return &tokenHandler{
...
func (s *tokenHandler) storeLinearToken(ctx context.Context, byName string, token *Token) error {
	...
	if err := s.secretManager.Set(ctx, SecretsPath, byName, string(data)); err != nil {
...
func (s *tokenHandler) getStoredLinearToken(ctx context.Context, byName string) (*Token, error) {
	raw, err := s.secretManager.Get(ctx, SecretsPath, byName)
